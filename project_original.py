...
train = pd.read_csv("C:/Users/risha/Desktop/project/Bigmart/trainnew2.csv")
test = pd.read_csv("C:/Users/risha/Desktop/project/Bigmart/testnew2.csv")
# print(train.head())
# train.info()
...
train.to_csv("C:/Users/risha/Desktop/project/Bigmart/trainnew2_modified.csv", index=False)
test.to_csv("C:/Users/risha/Desktop/project/Bigmart/testnew2_modified.csv", index=False)

train_df = pd.read_csv('C:/Users/risha/Desktop/project/Bigmart/trainnew2_modified.csv')
test_df = pd.read_csv('C:/Users/risha/Desktop/project/Bigmart/testnew2_modified.csv')
...
from sklearn import model_selection  #edited
...
# Perform cross-validation:
    #cv_score = cross_validation.cross_val_score(alg, dtrain[predictors], Sq_train, cv=20, scoring='neg_mean_squared_error') #edited
